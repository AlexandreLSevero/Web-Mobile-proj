/**
 * Geração da orientação por localidade (ideacao.md §5.8): um `{ tipo, mensagem }` por
 * localidade, no mesmo formato que `JS/inicializar-resultado.js` já lê
 * (`localidadeA.orientacao` / `localidadeB.orientacao`).
 *
